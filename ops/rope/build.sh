...
#
# Build RoPE op kernel ELFs.
#
# Produces (in $PREBUILT_DIR):
#   reader.brisc.elf
#   writer.ncrisc.elf
#   rope.trisc0.elf  rope.trisc1.elf  rope.trisc2.elf
...
BUILD="${BUILD:-/tmp/tt_foil_build_rope}"
...
build_compute() {
    ...
    # chlkc_list.h: CBs 0,1,2,3,4,5 (inputs/intermediates) and CB 16 (output) = BF16 (5)
...
#endif
// Float16_b (=5) for CBs 0-5 and 16; 255 for others
constexpr unsigned char pack_src_format[32] = {
    5,5,5,5,5,5,255,255,255,255,255,255,255,255,255,255,
...
build_compute "$HERE/compute.cpp" rope
