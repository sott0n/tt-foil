...
//
// Reuses the single-head MHA math (Phase 1 / 2a / 2m / 2b / 2c / 2d / 3)
// inside an outer head loop. Mask and scaler tiles stay resident in their
// CBs for the whole call; Q / KT / V are streamed per head by the reader.
//
// Runtime args (TRISC):
//   arg[0] = St
//   arg[1] = Dt
