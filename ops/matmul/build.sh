...
#
# Build MatMul op kernel ELFs.
#
# Produces (in $PREBUILT_DIR):
#   reader.brisc.elf
#   writer.ncrisc.elf
#   matmul.trisc0.elf  matmul.trisc1.elf  matmul.trisc2.elf
...
BUILD="${BUILD:-/tmp/tt_foil_build_matmul}"
...
build_compute "$HERE/compute.cpp" matmul
