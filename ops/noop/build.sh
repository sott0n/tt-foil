...
#
# Build G0 no-op kernel ELF. BRISC-only — empty kernel_main, used to
# measure firmware-side dispatch floor (G0 phase of perf plan).
#
# Produces:
#   prebuilt/noop.brisc.elf
...
build_one brisc 0 "$HERE/noop.cpp" noop.brisc
