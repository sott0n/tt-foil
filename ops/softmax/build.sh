...
#
# Build Softmax op kernel ELFs.
#
# Produces (in $PREBUILT_DIR):
#   reader.brisc.elf
#   writer.ncrisc.elf
#   softmax.trisc0.elf  softmax.trisc1.elf  softmax.trisc2.elf
...
BUILD="${BUILD:-/tmp/tt_foil_build_softmax}"
...
constexpr unsigned char pack_src_format[32] = {
    5,5,5,5,5,5,5,5,255,255,255,255,255,255,255,255,
...
build_compute "$HERE/compute.cpp" softmax
