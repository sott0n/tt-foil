...
//
// TRISC compute for the weight-stationary matmul (prefill). For each block of
// Mb cached A-rows and each B column nt, it produces mb output tiles by
// reusing the single cb_b column across the block's rows. DST_ACCUM_MODE=true
// accumulates the K-loop in FP32. With Mb=1 this matches ops/matmul/compute.cpp.
//
