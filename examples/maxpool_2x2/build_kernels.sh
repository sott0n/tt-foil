...
# maxpool_2x2 example (v8.1).  4-input → 1-output SFPU reduction: each
# of CBs c_0..c_3 carries one pool-window position, and the compute
# kernel pairwise-reduces them with binary_max into c_16.
#
# Required env vars:
...
// maxpool_2x2 uses CBs 0..3 (4 pool-window streams) + CB 16 (out), all bf16.
constexpr unsigned char pack_src_format[32] = {
    5,   5,   5,   5,   255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
