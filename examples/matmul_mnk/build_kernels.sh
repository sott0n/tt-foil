...
#
# Build pre-compiled BRISC + NCRISC + TRISC kernel ELFs for the matmul_mnk
# example (v5-3): general Mt×Kt × Kt×Nt → Mt×Nt single-core matmul.
# Iterates output tiles, K-loops each with DST_ACCUM_MODE=true.
#
