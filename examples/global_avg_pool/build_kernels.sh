...
# example (v5.7).  Multi-tile sum reduce (PoolType::SUM, ReduceDim::REDUCE_ROW). c_0 carries Nt input tiles, c_1 carries a persistent scaler tile
# tile, filled with 1/HW. Output to c_16 is one tile with per-channel
# means in col 0..  Output to c_16.
# 
#
# Required env vars:
