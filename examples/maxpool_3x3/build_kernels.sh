...
# maxpool_3x3 example. 9-input → 1-output SFPU reduction: each of CBs
# c_0..c_8 carries one 3×3 pool-window position, and the compute kernel
# pairwise-reduces them with binary_max into c_16. Same pattern as
# maxpool_2x2 with the stream count widened to nine.
#
# Required env vars:
...
// maxpool_3x3 uses CBs 0..8 (9 pool-window streams) + CB 16 (out), all bf16.
constexpr unsigned char pack_src_format[32] = {
    5,   5,   5,   5,   5,   5,   5,   5,   5,   255, 255, 255, 255, 255, 255, 255,
