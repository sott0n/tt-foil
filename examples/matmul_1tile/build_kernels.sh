...
# matmul_1tile example (v5-1). Same pipeline structure as tile_copy: one
# BRISC reader that fills CB c_0 (A) and c_1 (B), one TRISC compute that
# runs matmul_tiles into CB c_16, one NCRISC writer that drains c_16 to L1.
#
# Required env vars:
